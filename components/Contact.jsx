...
const Contact = () => {
    ...
    return (
        <section className="contact-section pt-150 pb-140 bg_img" data-background="/assets/img/bg/contact-bg.png" style={{ backgroundImage: "url('/assets/img/bg/contact-bg.png')" }}>
                    ...
                    <div className="col-lg-6 mt-50">
                        <div className="xb-content-wrap">
                            <div className="sec-title contact-sec-title">
                                ...
                                <h2 className="title horizontal-shape">We are trusted Ai agency</h2>
                            </div>
                            <div className="xb-contact-conent wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="600ms">
                                <div className="xb-contact-inner ul_li_between">
                                    <div className="xb-contact-item">
                                        <h3 className="xb-item--number xb-odm"><span className="xbo" data-count="99">99</span><span className="suffix">+</span></h3>
                                        <p className="xb-item--content">Projects Successfully Delivered</p>
                                    </div>
                                    <div className="xb-contact-item">
                                        <h3 className="xb-item--number xb-odm"><span className="xbo" data-count="95">95</span><span className="suffix">%</span></h3>
