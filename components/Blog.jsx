...
const Blog = () => {
    ...
    return (
        <section className="blog pt-150 bg_img" data-background="/assets/img/bg/blog-bg.png" style={{ backgroundImage: "url('/assets/img/bg/blog-bg.png')" }}>
                        ...
                        <div className="row mt-none-30">
                                ...
                                <div className="xb-blog-item wow fadeInUp" data-wow-delay="0ms" data-wow-duration="600ms">
                                    <div className="xb-item--inner img-hove-effect xb-border">
                                        <div className="xb-img">
                                            <Link href="/blog-details"><img src="/assets/img/blog/img01.jpg" alt="image" /></Link>
                                        </div>
                                        <div className="xb-item--holder">
                                            ...
                                            <h2 className="xb-item--title">
                                                <Link href="/blog-details">How AI is transforming modern business operations and driving innovation everything you need to know..</Link>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-6 col-md-6 mt-30">
                                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="150ms" data-wow-duration="600ms">
                                    <div className="xb-item--inner img-hove-effect xb-border">
                                        <div className="xb-img">
                                            <Link href="/blog-details"><img src="/assets/img/blog/img02.jpg" alt="image" /></Link>
                                        </div>
                                        <div className="xb-item--holder">
                                            <ul className="xb-item--meta list-unstyled ul_li">
                                            ...
                                            <h2 className="xb-item--title">
                                                <Link href="/blog-details">AI chatbots vs human support which is best for?..</Link>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-6 col-md-6 mt-30">
                                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="600ms">
                                    <div className="xb-item--inner img-hove-effect xb-border">
                                        <div className="xb-img">
                                            <Link href="/blog-details"><img src="/assets/img/blog/img03.jpg" alt="image" /></Link>
                                        </div>
                                        <div className="xb-item--holder">
                                            <ul className="xb-item--meta list-unstyled ul_li">
                                            ...
                                            <h2 className="xb-item--title">
                                                <Link href="/blog-details">How E-commerce brands use AI to increase sales..</Link>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
